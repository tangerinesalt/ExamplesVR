...
public class VRPrefabControl : NetworkBehaviour
{

    [Header("Test Setting")]
    [SerializeField] private bool m_IsOpenTestSetting = false;


    [Header("Sync Tool Prefab")]
    [SerializeField] private Transform m_SyncToolPrefabRoot = null;
    [SerializeField] private Transform m_SyncToolHead = null;
    [SerializeField] private Transform m_SyncToolLeftHand = null;
    [SerializeField] private Transform m_SyncToolRightHand = null;
    ...
    private void Start()
    {
        if(m_IsOpenTestSetting)
        {
            Camera camera = VRMainManager.Instance.GetVRRoot().GetComponentInChildren<Camera>();
