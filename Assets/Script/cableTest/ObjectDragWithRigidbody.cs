...
public class ObjectDraggerWithRigidbody : MonoBehaviour
{
    public Rigidbody rb;
	...
	void OnMouseDrag()
	{
        Vector3 curScreenPoint = new Vector3(Input.mousePosition.x, Input.mousePosition.y, screenPoint.z);
         ...
         //rb.AddForce(direction * dragForceMagnitude, ForceMode.VelocityChange);
         rb.velocity = direction * dragForceMagnitude;
	}
}
